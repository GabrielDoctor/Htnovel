      ...
      {selectedChapters.length > 0 &&
        selectedChapters.map((chapter: any) => (
          <Link
            ...
            className="w-full h-12 p-2 rounded-md flex items-center justify-between truncate hover:bg-gray-200 dark:hover:bg-slate-600"
          >
            <div>#{chapter.chapter_index}</div>
            <div>{chapter.chapter_title}</div>
            <div className="hidden md:block">{chapter.volumn_name}</div>
